...
TEST_F(ArionTest, SimpleThreads)
{
    ...
    std::shared_ptr<Arion> arion = Arion::new_instance({this->targets_path+"/multi_thread/build/multi_thread"}, "/", {}, std::filesystem::current_path(), std::move(config));
