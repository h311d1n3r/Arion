...
protected:
    ...
    LinuxLoader(std::weak_ptr<Arion> arion, const std::vector<std::string> program_args, const std::vector<std::string> program_env) : arion(arion), program_args(program_args), program_env(program_env) {};
