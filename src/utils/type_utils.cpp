...
std::shared_ptr<ArionIntType> arion::ARION_INT_TYPE;
std::shared_ptr<ArionRawStringType> arion::ARION_RAW_STRING_TYPE;
...
std::vector<arion::BYTE> arion_poly_struct::AbsArionStructType::arion_read_mem(std::shared_ptr<Arion> arion,
